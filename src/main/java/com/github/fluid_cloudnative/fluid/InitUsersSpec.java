...
public class InitUsersSpec {
  ...
  **/
   ...
   * @return resources
  **/
  @ApiModelProperty(value = "Resources that will be requested by initialize the users for runtime. <br> <br> Resources are not allowed for ephemeral containers. Ephemeral containers use spare resources already allocated to the pod.")
